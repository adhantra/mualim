        ...
        <div class="col-lg-12 col-md-12 col-sm-12 body">
			<div class="col-lg-2 col-md-4 col-sm-4 col-xs-12 left">
				...
				<div class="menu">
					<ul>
						<li>
							<a href="../index.html" class="text-menu">Home</a>
						</li>
						<br>
						<li>
			...
			<div class="col-lg-10 col-md-8 col-sm-8 col-xs-12 right">
				<section id="content-1">
        			<div class="col-md-12 col-sm-12 col-xs-12 box-1-alquran">
						<p class="text-title-box">Add Hadist</p>
						<br>
						<form>
							<div class="form-group col-lg-4 col-md-4">
								<label for="inputRiwayat">By</label>
								<input type="text" class="form-control" id="inputRiwayat">
							</div>
							<div class="form-group col-lg-2 col-md-2">
								<label for="inputNoHadist">No Hadist</label>
								<input type="text" class="form-control" id="inputNoHadist" placeholder="">
							</div>
							<div class="form-group col-lg-4 col-md-4">
								<label for="input">Lorem</label>
